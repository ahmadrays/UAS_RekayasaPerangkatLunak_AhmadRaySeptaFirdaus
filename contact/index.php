...
<body class="contact">
  ...
  <!-- contact -->
  <form class="form" data-aos="flip-up">
    <h2 class="head-contact">Buy Product?</h2>
    <p class="p-contact" type="Name:"><input class="input-contact" placeholder="Write your name here.."></input></p>
    <p class="p-contact" type="Email:"><input class="input-contact" placeholder="Your Email.."></input></p>
    <p type="Message:"><input class="input-contact" placeholder="What would you like to tell us.."></input></p>
    <button class="btn-contact">Send Message</button>
    <div class="foot-contact">
      <span class="fa fa-phone spn-foot-contact"></span>0812-9435-8571
      <span class="fa fa-envelope-o spn-foot-contact"></span>rhymebounty@gmail.com
    </div>
  </form>
  <!-- contact -->
